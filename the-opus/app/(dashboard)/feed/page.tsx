        ...
        <div key={author} className="flex items-center justify-between group">
          <div className="flex items-center gap-3">
            ...
            <div className="relative shrink-0">
              <div className="w-9 h-9 rounded-full border border-slate-700 group-hover:border-slate-500 transition-colors overflow-hidden bg-slate-800">
                {avatarUrl ? (
            ...
            <p className="text-sm font-medium text-slate-300 group-hover:text-white transition-colors truncate max-w-[120px]">
              {author}
            </p>
          </div>
