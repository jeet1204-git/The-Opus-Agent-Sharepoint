  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0b1120] text-slate-200 font-sans">
      <div className="w-full max-w-sm rounded-2xl border border-slate-800 bg-[#0f172a] p-8 shadow-2xl">
        ...
        {token ? (
          <>
            <h2 className="mb-1 text-xl font-semibold text-white">Choose a password</h2>
          ...
          <div className="text-center">
            ...
            <h2 className="mb-1 text-lg font-semibold text-white">Invalid link</h2>
            <p className="mb-6 text-sm text-slate-400">
              This activation link is missing or invalid. Ask your admin to re-send it.
            </p>
            <Link href="/signup" className="text-sm font-medium text-blue-400 hover:text-blue-300">
              ← Back to sign up
            </Link>
          </div>
        )}
