  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0b1120] text-slate-200 font-sans">
      <div className="w-full max-w-sm rounded-2xl border border-slate-800 bg-[#0f172a] p-8 shadow-2xl">
        ...
        {view.kind === "form" && (
          <>
            <h2 className="mb-1 text-xl font-semibold text-white">Create your account</h2>
            <p className="mb-6 text-sm text-slate-500">
              Use your <span className="text-slate-300">work email</span>. Only emails your
        ...
        {view.kind === "rejected" && (
          <div className="text-center">
            ...
            <h2 className="mb-1 text-lg font-semibold text-white">Email not registered</h2>
        ...
        {view.kind === "active" && (
          <div className="text-center">
            ...
            <h2 className="mb-1 text-lg font-semibold text-white">Account already exists</h2>
            <p className="mb-6 text-sm text-slate-400">This email is already activated.</p>
            <Link
              href="/login"
              className="inline-flex items-center gap-2 rounded-md bg-blue-600 px-5 py-2 font-bold text-white transition-colors hover:bg-blue-500"
            >
        ...
        {view.kind === "invited" && (
          <div className="text-center">
            <MailCheck size={36} className="mx-auto mb-3 text-blue-400" />
            <h2 className="mb-1 text-lg font-semibold text-white">Check your email</h2>
            <p className="mb-2 text-sm text-slate-400">
              We&apos;ve sent a secure activation link to{" "}
              <span className="text-slate-200">{view.email}</span>.
            </p>
